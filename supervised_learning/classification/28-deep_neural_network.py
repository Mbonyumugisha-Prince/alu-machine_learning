#!/usr/bin/env python3
"""Module defining a deep neural network with configurable activation."""
...
class DeepNeuralNetwork:
    """Deep neural network with configurable hidden layer activation."""
    ...
    def forward_prop(self, X):
        """Calculate forward propagation using configured activation."""
        self.__cache['A0'] = X
        for idx in range(1, self.__L + 1):
